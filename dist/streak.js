...
export function renderStreakGraph(container, contributions) {
    container.innerHTML = '';
    const weeks = d3.groups(contributions, d => d3.timeWeek.floor(new Date(d.date + 'T12:00:00')).toISOString());
